...
public class ControleFornecedor {
	...
	/**
	 * Edita um fornecedor cadastrado, a partir do nome, atributo que ele quer
	 * alterar e o novo valor do atributo.
	 * 
	 * @param nome      nome do fornecedor
	...
	/**
	 * remove um produto a partir do seu nome, descrição e o nome do fornecedor
	 * associado.
	 * 
	...
	/**
	 * edita um produto a partir do seu nome, descricao, e o o nome do fornecedor e
	 * o novo preço a ser colocado .
	 * 
	 * @param nome       nome do produto
	 * @param descricao  descricao do produto
	...
	/**
	 * Cadastra produto a partir do nome do fornecedor e o nome, descrição e preço
	 * do produto
	 * 
	 * @param fornecedor nome do fornecedor
	 * @param nome       nome do produto
	...
	public String exibeProdutos() {
		...
		Collections.sort(fornecedorList);
		for (Fornecedor fornecedor : fornecedorList) {
			result = result + fornecedor.imprimeTodosProdutos() + " | " ;
		} 
